        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
                <h3 className="text-xl font-bold mb-4">{product.cName}</h3>
                <Image src={product.image} alt={product.cName}/>
                <p className="text-gray-600 mb-4">{product.cDescription}</p>
                <Link 
